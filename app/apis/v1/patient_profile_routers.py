...
# ------------------------------------------------------------
@router.get("/links/{link_id}/health-profile", response_model=ApiResponse[PatientProfileOut], status_code=status.HTTP_200_OK)
...
# ------------------------------------------------------------
@router.post("/links/{link_id}/health-profile", response_model=ApiResponse[PatientProfileOut], status_code=status.HTTP_201_CREATED)
...
# ------------------------------------------------------------
@router.patch("/links/{link_id}/health-profile", response_model=ApiResponse[PatientProfileOut], status_code=status.HTTP_200_OK)
