...
class NotificationService:
    ...
    async def mark_all_read(self, user_id: int) -> int:
        ...
        """
        return await Notification.filter(user_id=user_id, read_at__isnull=True).update(
            read_at=now_utc_naive()
        )
    ...
    async def _ensure_caregiver_can_access_patient(
        ...
        *,
        ...
        CaregiverPatientLink = _resolve_caregiver_patient_link_model()
