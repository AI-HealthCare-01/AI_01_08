...
def test_parse_extracted_meds_uses_med_guide_table_parser_with_ocr_fields():
    ...
    ocr_fields = [
        ...
        {"text": "인데놀정40mg", "x_min": 40.0, "x_max": 190.0, "y_min": 120.0, "y_max": 140.0, "cx": 115.0, "cy": 130.0},
        {"text": "0.5정씩 3회 7일분", "x_min": 280.0, "x_max": 430.0, "y_min": 120.0, "y_max": 140.0, "cx": 355.0, "cy": 130.0},
        {"text": "튜란트과립200mg", "x_min": 40.0, "x_max": 200.0, "y_min": 150.0, "y_max": 170.0, "cx": 120.0, "cy": 160.0},
        {"text": "1포씩 3회 5일분", "x_min": 280.0, "x_max": 410.0, "y_min": 150.0, "y_max": 170.0, "cx": 345.0, "cy": 160.0},
    ]
...
def test_parse_med_guide_table_skips_descriptor_rows_and_attaches_schedule_to_pending():
    ...
    ocr_fields = [
        {"text": "약품명", "x_min": 40.0, "x_max": 120.0, "y_min": 90.0, "y_max": 110.0, "cx": 80.0, "cy": 100.0},
        {"text": "복약안내", "x_min": 280.0, "x_max": 360.0, "y_min": 90.0, "y_max": 110.0, "cx": 320.0, "cy": 100.0},
        {"text": "인데놀정40mg B", "x_min": 40.0, "x_max": 200.0, "y_min": 120.0, "y_max": 140.0, "cx": 120.0, "cy": 130.0},
        {"text": "분할선을 가진 흰색의 소화관", "x_min": 40.0, "x_max": 240.0, "y_min": 145.0, "y_max": 165.0, "cx": 140.0, "cy": 155.0},
        {"text": "0.5정씩 3회 7일분", "x_min": 280.0, "x_max": 430.0, "y_min": 170.0, "y_max": 190.0, "cx": 355.0, "cy": 180.0},
        {"text": "에나론정10mg 삼환계", "x_min": 40.0, "x_max": 220.0, "y_min": 200.0, "y_max": 220.0, "cx": 130.0, "cy": 210.0},
        {"text": "불면증", "x_min": 40.0, "x_max": 100.0, "y_min": 225.0, "y_max": 245.0, "cx": 70.0, "cy": 235.0},
        {"text": "1정씩 1회 14일분", "x_min": 280.0, "x_max": 420.0, "y_min": 250.0, "y_max": 270.0, "cx": 350.0, "cy": 260.0},
    ]
...
def test_med_guide_parser_stops_before_summary_table_rows():
    ...
    ocr_fields = [
        {"text": "약품명", "x_min": 40.0, "x_max": 120.0, "y_min": 90.0, "y_max": 110.0, "cx": 80.0, "cy": 100.0},
        {"text": "복약안내", "x_min": 280.0, "x_max": 360.0, "y_min": 90.0, "y_max": 110.0, "cx": 320.0, "cy": 100.0},
        {"text": "진양에페리손정에페", "x_min": 40.0, "x_max": 220.0, "y_min": 120.0, "y_max": 140.0, "cx": 130.0, "cy": 130.0},
        {"text": "1정씩 3회 5일분", "x_min": 280.0, "x_max": 410.0, "y_min": 120.0, "y_max": 140.0, "cx": 345.0, "cy": 130.0},
        ...
        {"text": "슈다페드정슈도에페", "x_min": 40.0, "x_max": 210.0, "y_min": 230.0, "y_max": 250.0, "cx": 125.0, "cy": 240.0},
    ]
...
def test_segment_layout_regions_separates_med_guide_and_summary():
    ...
    ocr_fields = [
        ...
        {"text": "약품명", "x_min": 40.0, "x_max": 120.0, "y_min": 90.0, "y_max": 110.0, "cx": 80.0, "cy": 100.0},
        {"text": "복약안내", "x_min": 280.0, "x_max": 360.0, "y_min": 90.0, "y_max": 110.0, "cx": 320.0, "cy": 100.0},
        {"text": "슈다페드정슈도에페", "x_min": 40.0, "x_max": 210.0, "y_min": 125.0, "y_max": 145.0, "cx": 125.0, "cy": 135.0},
        {"text": "1정씩 2회 5일분", "x_min": 280.0, "x_max": 420.0, "y_min": 125.0, "y_max": 145.0, "cx": 350.0, "cy": 135.0},
...
def test_pipeline_parses_med_blocks_and_normalizes_with_summary_dictionary():
    ...
    ocr_fields = [
        {"text": "약품명", "x_min": 40.0, "x_max": 120.0, "y_min": 90.0, "y_max": 110.0, "cx": 80.0, "cy": 100.0},
        {"text": "복약안내", "x_min": 280.0, "x_max": 360.0, "y_min": 90.0, "y_max": 110.0, "cx": 320.0, "cy": 100.0},
        {"text": "슈다페드정슈도에페", "x_min": 40.0, "x_max": 210.0, "y_min": 130.0, "y_max": 150.0, "cx": 125.0, "cy": 140.0},
        {"text": "백색의 장방형 정제", "x_min": 40.0, "x_max": 220.0, "y_min": 158.0, "y_max": 178.0, "cx": 130.0, "cy": 168.0},
        {"text": "1정씩 2회 5일분", "x_min": 280.0, "x_max": 420.0, "y_min": 186.0, "y_max": 206.0, "cx": 350.0, "cy": 196.0},
